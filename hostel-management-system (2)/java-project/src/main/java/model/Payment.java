 ...
 *         }
 *     }
 * }nting 'payments' table (Financial Ledger System).
 */
public class Payment implements Serializable {
    ...
    private String paymentDate; // Represented as "yyyy-MM-dd"
    private String paymentStatus; // Paid, Pending

    // Un-mapped Join Fields for easy JSP display grids
    ...
    public Payment(int paymentId, int studentId, double amount, String paymentDate, String paymentStatus) {
    ...
    public Payment(int studentId, double amount, String paymentDate, String paymentStatus) {
        this.studentId = studentId;
        this.amount = amount;
        this.paymentDate = paymentDate;
        this.paymentStatus = paymentStatus;
